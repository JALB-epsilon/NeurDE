...
STAGE1_DIR="results/case2/stage1_geq_positive_main_clean"
STAGE2_DIR="results/case2/stage2_geq_positive_main_clean"

mkdir -p "$STAGE1_DIR" "$STAGE2_DIR"

"$PYTHON_BIN" train_stage_1_geq_main.py \
  --device 0 \
  --case 2 \
  --num_samples 500 \
  --batch_size 32 \
...
"$PYTHON_BIN" train_stage_2_geq_main.py \
  --device 0 \
